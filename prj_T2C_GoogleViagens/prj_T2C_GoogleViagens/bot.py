...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_clssSendEmail = T2CSendEmail(arg_strEmailServerSmtp="smtp-mail.outlook.com", arg_intEmailPortaSmtp="587", arg_strUsuario="bonilha.laura@gmail.com", arg_strSenha="Senha1234",arg_strNomeProcesso=var_strNomeProcesso, arg_clssMaestro=var_clssMaestro)
